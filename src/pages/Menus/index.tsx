...
// import { getMenus, createMenu, updateMenu, deleteMenu } from '@/services/ant-design-pro/menus';
...
// const handleDeleteMenu: (menu: API.Menu) => Promise<boolean> = async (menu) => {
//   const hide = message.loading('正在删除菜单....');

//   const resp = await deleteMenu(menu);
...
//                 icon={<DeleteOutlined />}
//                 onClick={async () => {
//                   const result = await handleDeleteMenu(entity);
//                   if (result) {
